...
<head>
	...
	<script>
		...
		/* funcao que chama metodo para editar tarefa */
		function editar(id, txt_tarefa) {

			// cria um form de edicao
			...
			// cria input hidden para armezenar Id
			...
			// inclui button no form
			form.appendChild(button)

			// seleiona a div tarefa
			let tarefa = document.getElementById('tarefa_' + id)

			// limpa o texto da tarefa para inclusao do form
			tarefa.innerHTML = ''

			// inclui form na pagina
			tarefa.insertBefore(form, tarefa[0])
		}

		/* funcao que chama metodo excluir */
		function excluir(id) {

			location.href = 'todas_tarefas.php?acao=excluir&id=' + id; // redireciona para script php

		}

		/* funcao que chama metodo marcar tarefa como realizada */
